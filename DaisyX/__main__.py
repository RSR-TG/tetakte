...
✪ Ka hnathawh theih i hriat duh chuan /help tih hi click rawh,chuan harsatna i neih hun a i sawi theih nan a hnuai button a Channel leh Group hi join rawh ✪ 
"""
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="➕ Group a Add na ➕", url="t.me/tereuhte_bot?startgroup=true"
        ),
    ],
]
